<div class="wrapper container-fluid">
	{!! Form::open(['url'=>route('serviceEdit',array('page'=>$data['id'])),'class'=>'form-horizontal','method'=>'post','enctype'=>'multipart/form-data']) !!}
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				{!! Form::text('text',$data['text'],['class'=>'form-control','id'=>'editor','placeholder'=>'Enter page text']) !!}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-8">
				{!! Form::text('icon',$data['icon'],['class'=>'form-control','placeholder'=>'Enter page icon']) !!}				
			</div>
		</div>
